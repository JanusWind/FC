...
plt.plot( dat1_db, xx, color='gray' )
plt.plot( xx, dat1_db, color='gray' )

plt.xticks([0, 0.015, 0.03, 0.045, 0.06, 0.075], fontsize=20)
plt.yticks([0, 0.015, 0.03, 0.045, 0.06, 0.075], fontsize=20)

plt.text( 0.058, 0.0485, 'Fit Slope = ' '%s' r'$\, \pm \,$' '%s'
%( round( m1, 2 ), round( mean( dat1_m ), 2 ) ), fontsize = 24, rotation=30 )

plt.text( 0.052, 0.066, 'Expected Slope = 1', fontsize = 24, rotation=42 )
...
plt.savefig('fv_delb_fz01'+'.eps', bbox_inches='tight', dpi=500)
