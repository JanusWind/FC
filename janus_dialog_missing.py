...
################################################################################
## DEFINE CLASS "dialog_missing" TO CUSTOMIZE "QDialog" FOR A MISSING FEATURE.
################################################################################

class dialog_missing( QDialog ) :
	...
	def user_event( self, event, fnc ) :
		...
		# If the user pressed the 'OK' button, close this dialog window.
	...
	#-----------------------------------------------------------------------
	# DEFINE THE FUNCTION FOR WAITING FOR THE USER'S ACKNOWLEDGEMENT.
	#-----------------------------------------------------------------------
