...
try :
	...
	axs1[0].scatter( range( len( dat1 ) ), dat1_fv_p_c, marker='*', color='b',
	label='Proton Core' )
	axs1[0].scatter( range( len( dat1 ) ), dat1_fv_p_b, marker='v', color='r',
	label='Proton Beam' )

	axs1[0].legend( )

	axs1[1].scatter( dat1_s_db, dat1_s_fv_p_c, marker='d', color='b' )

	axs1[2].scatter( dat1_s_db, dat1_s_fv_p_b, marker='D', color='b' )
