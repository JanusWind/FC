...
class widget_mfi_fmo_plot( QWidget ) :
	...
	def make_plt( self ) :
		...
		self.plt.addItem( self.crv_x_m )
		self.plt.addItem( self.crv_y_m )
		self.plt.addItem( self.crv_z_m )
	...
	def rset_plt( self ) :
		...
		if ( self.crv_x_m is not None ) :
			self.plt.removeItem( self.crv_x_m )

		if ( self.crv_y_m is not None ) :
			self.plt.removeItem( self.crv_y_m )
